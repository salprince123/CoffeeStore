    ...
    public partial class AccountList : UserControl
    {
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            Window window = new Window
            {
                ...
                WindowStyle = WindowStyle.None,
                Title = "Xóa tài khoản",
                Content = new PopupDeleteConfirm($"Bạn có chắc chắn muốn xóa tài khoản {row.id} \n của nhân viên {row.name} không?", row.id),
                Width = 380,
                Height = 210,
                Left = (Application.Current.MainWindow.Left + Application.Current.MainWindow.Width - 350) / 2,
                Top = (Application.Current.MainWindow.Top + Application.Current.MainWindow.Height - 200) / 2,
            };
            window.ShowDialog();
            LoadData();
            ((MainWindow)App.Current.MainWindow).Opacity = 1;
